...
import { isSupportedTransaction } from "../../../../headless/action/helpers/tx-type-check"
import {
  PAYER_INFO,
...
} from "../../../../headless/action/send-transaction/prepare-tx"
...
vi.mock("../../../../headless/action/send-transaction/estimate-fee-per-gas", () => ({
